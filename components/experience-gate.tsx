...
export function ExperienceGate({
    ...
    return (
      <section id="immersive" className="relative p-12 lg:p-24 rounded-[32px] overflow-hidden bg-neutral-900 border border-neutral-800 flex flex-col items-center text-center space-y-10 group shadow-2xl">
        ...
        <Button 
          ...
          className="relative group/btn h-16 px-10 rounded-2xl bg-[color:var(--accent)] text-xs font-black uppercase tracking-[0.3em] text-black transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[color:var(--accent)]/20"
        >
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-xl animate-in fade-in duration-500 p-6">
      <Card className="w-full max-w-md bg-neutral-900 border-neutral-800 p-8 md:p-12 relative overflow-hidden shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
        {/* Decorative background */}
        <div className="absolute -top-24 -right-24 h-64 w-64 bg-[#C9A46C]/5 blur-[80px] rounded-full pointer-events-none" />

        <div className="relative z-10 space-y-8">
          {step === "gate" ? (
             <>
               <div className="text-center space-y-3">
                  <div className="mx-auto h-12 w-12 rounded-xl bg-neutral-800 border border-neutral-700 flex items-center justify-center mb-4">
                     <User className="h-6 w-6 text-[color:var(--accent)]" />
                  </div>
               ...
               <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-4">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <Input 
                          ...
                          className="h-12 pl-10 bg-black/40 border-neutral-800 text-xs" 
                        />
                      </div>
                    </div>

                    <div className="space-y-1.5">
                      <Label className="text-[10px] uppercase font-black tracking-widest text-neutral-500 ml-1">Work Email</Label>
                      <div className="relative">
                    ...
                    <div className="space-y-1.5 inquiry-phone-input">
                      <Label className="text-[10px] uppercase font-black tracking-widest text-neutral-500 ml-1">Phone Number</Label>
                      <PhoneInput
                        defaultCountry="IN"
                        value={phone}
                        onChange={setPhone}
                        className="phone-input-container bg-black/40 border border-neutral-800 rounded-md px-3 h-12"
                        placeholder="Enter phone"
                      />
                    </div>

                    {authType === "password" && (
                      <div className="space-y-1.5 pt-2 border-t border-neutral-800/50 mt-4">
                  ...
                  <Button 
                    ...
                    className="w-full h-14 bg-[color:var(--accent)] text-black font-black uppercase text-[10px] tracking-[0.3em] rounded-xl hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-[color:var(--accent)]/10"
                  >
               ...
               <button 
                  ...
                  className="w-full text-[10px] uppercase font-bold text-neutral-600 hover:text-neutral-400 tracking-widest transition-colors pt-2"
                >
                  Cancel
               </button>
             </>
             ...
             <div className="text-center space-y-6 py-12 animate-in zoom-in-95 duration-500">
                ...
                <div className="space-y-1">
                   <h4 className="text-xl font-black uppercase italic tracking-tighter">Access Granted</h4>
                   <p className="text-xs text-neutral-500 uppercase font-bold tracking-widest">Opening internal stream...</p>
                </div>
                <div className="w-full max-w-[120px] mx-auto h-1 bg-neutral-800 rounded-full overflow-hidden">
                   <div className="h-full bg-emerald-500 animate-progress-fast" />
                </div>
                <p className="text-[10px] uppercase tracking-[0.2em] text-neutral-600 animate-pulse font-black italic">Launching Digital Atmosphere</p>
             </div>
          )}
        </div>
      </Card>
