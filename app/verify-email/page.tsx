    ...
    <div className="flex min-h-screen items-center justify-center px-4 bg-bg">
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="space-y-3 text-center">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-bg-soft border border-border text-accent mb-6 shadow-xl">
        ...
        {/* Card */}
        <div className="rounded-2xl border border-border bg-bg-soft p-8 shadow-2xl relative overflow-hidden group">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="h-8 w-8 rounded-lg bg-bg-soft border border-border flex items-center justify-center shrink-0">
                <Inbox className="h-4 w-4 text-text-secondary" />
              </div>
              <div className="space-y-1">
                <h3 className="text-sm font-bold text-text">Check your inbox</h3>
