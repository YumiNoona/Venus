      ...
      <div className="w-full max-w-[700px] space-y-12">
        ...
        <div className="space-y-6 pt-12 border-t border-border">
            <div className="space-y-1">
              ...
              <p className="text-sm text-text-secondary italic">Connect your own brand to the Venus experience.</p>
            </div>
            
            <Card className="p-8 bg-bg-soft/40 border-border relative group overflow-hidden">
                {!features.white_label && (
                   <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px] z-10 flex flex-col items-center justify-center p-6 text-center space-y-4 animate-in fade-in duration-500">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-text-secondary max-w-[280px]">Custom domain binding is exclusive to Agency partners. Upgrade to connect your domain.</p>
                      </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="h-10 w-10 shrink-0 rounded-xl bg-bg-soft border border-border flex items-center justify-center">
                    <Globe className="h-5 w-5 text-text-secondary" />
                  </div>
                  <div className="space-y-4 flex-1">
                    <div className="space-y-1">
                      <Label className="text-xs font-bold uppercase tracking-widest text-text-secondary">Primary Domain</Label>
                      <p className="text-sm text-text-secondary">No custom domains connected.</p>
                    </div>
                  </div>
                </div>
            </Card>
